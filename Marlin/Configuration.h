...
#define STRING_CONFIG_H_AUTHOR "(kw, thisiskeithb, Ender-3)" // Who made the changes.
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  #define DEFAULT_Kp 16.78
  #define DEFAULT_Ki 3.15
  #define DEFAULT_Kd 22.34
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 400, 408.87 }
...
#define X_BED_SIZE 232 // x homes to ~3mm on bed
#define Y_BED_SIZE 235

// Travel limits (mm) after homing, corresponding to endstop positions.
#define X_MIN_POS 0 // -left +right
#define Y_MIN_POS -19 // -up +down
#define Z_MIN_POS 0
#define X_MAX_POS X_BED_SIZE
#define Y_MAX_POS 225 // lost due to new v6 clone position
...
//#define DEBUG_LEVELING_FEATURE
  ...
  #define FRONT_PROBE_BED_POSITION (MIN_PROBE_EDGE + MY_Y_MIN_PROBE_EDGE + Y_PROBE_OFFSET_FROM_EXTRUDER)
