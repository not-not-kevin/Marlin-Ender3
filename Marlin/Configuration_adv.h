 ...
 */
  ...
  #define MY_Y_MIN_PROBE_EDGE 10 // y only offset to prevent probe from missing front/back edge.

  #define PROBING_MARGIN_LEFT (PROBING_MARGIN + ((xyz_pos_t)NOZZLE_TO_PROBE_OFFSET).x)
  #define PROBING_MARGIN_RIGHT (PROBING_MARGIN_LEFT)
  #define PROBING_MARGIN_FRONT (PROBING_MARGIN + MY_Y_MIN_PROBE_EDGE + ((xyz_pos_t)NOZZLE_TO_PROBE_OFFSET).y)
  #define PROBING_MARGIN_BACK (PROBING_MARGIN_FRONT)
#endif
